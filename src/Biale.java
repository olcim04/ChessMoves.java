public class Biale extends PanelWyswietlenia{
    ...
    void Bpion(String[][] p, int a, int b) {
        String znaczek = " X";
        if (a == 1) {
            p[a + 1][b] = znaczek;
            p[a + 2][b] = znaczek;
    ...
    public void Skoczek(String[][]p, int a, int b) {
        String znaczek=" X";
        if(a>1 && a<6 && b>1 && b<6) {
            p[a - 2][b - 1] = znaczek;
            p[a - 2][b + 1] = znaczek;
    ...
    public void Sprawdzenie(String figura, int zmienA, int zmienB) {
    ...
    public String[][] getPlansza() {
        // Tu powinieneś zwrócić uzupelnioną planszę
        return plansza;
    }
